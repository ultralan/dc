...
CHANNEL_IDS = tuple(range(9, 17))


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Download and extract RealMAN ring2 8ch data.")
    parser.add_argument("--raw-dir", type=Path, default=Path("realman_demo/raw"))
    parser.add_argument("--output-dir", type=Path, default=Path("realman_demo/extracted/ring2_8ch"))
    parser.add_argument("--temp-dir", type=Path, default=Path("realman_demo/tmp_download"))
    parser.add_argument(
        "--csv",
        type=Path,
        nargs="+",
